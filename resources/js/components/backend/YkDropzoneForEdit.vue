...
export default {
    ...
    mounted() {
        ...
        this.valuable_product =
            this.editdata.တန်ဖိုးမြင့်အထည်_နှင့်_အထည်မပျက်ပြန်လဲ;
...
<!--                <div class="dz-error-mark"><i class="fa fa-close"></i></div>-->
        ...
        callaftermount: function () {
            ...
            if (this.editdata.photo_one != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_one
                );
            }
            if (this.editdata.photo_two != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_two
                );
            }
            ...
            if (this.editdata.photo_four != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_four
                );
            }
            if (this.editdata.photo_five != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_five
                );
            }
            if (this.editdata.photo_six != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_six
                );
            }
            ...
            if (this.editdata.photo_nine != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_nine
                );
            }
            if (this.editdata.photo_ten != "") {
                ...
                url.push(
                    this.$hostname + "/images/items/" + this.editdata.photo_ten
                );
            }
        ...
        submitform: function (event) {
            ...
            var temlength =(this.existingFiles.length - this.removeimgqueue.length)  +  this.$refs.myVueDropzone.getAcceptedFiles().length;
            console.log('fefe');
