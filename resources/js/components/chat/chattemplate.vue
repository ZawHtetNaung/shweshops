                ...
                <div>
                    <img
                        ...
                        :src="
                            this.host +
                            '/images/logo/thumbs/' +
                            this.shopdata.shop_logo
                        "
                    />
                </div>
                <span
                    class="active-now"
                    v-if="this.shopdata.status == 'online'"
                >
                </span>
...
export default {
    ...
    methods: {
        ...
        sendmsg: async function (enterorsendclick) {
            ...
            if (this.chatdatabytyping != "") {
                ...
                if (
                    ...
                    if (
                        localStorage.getItem(data.to_id + "_messages") !== null
                    ) {
                        var tmplsd = JSON.parse(
                            localStorage.getItem(data.to_id + "_messages")
                        );
                        tmplsd.data.data.messages.unshift(data);
                        localStorage.setItem(
                            data.to_id + "_messages",
        ...
        reachedtop: async function () {
            ...
            if (
                localStorage.getItem(this.currentuserid + "_messages") !== null
            ) {
