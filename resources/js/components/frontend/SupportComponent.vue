                ...
                <div class="col-6  mb-4 display-6" style="color:black;font-weight: bold;">
                    <div class="row no-gutters">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <a v-if="this.shopauth == 'no'" style="color:#780116 !important;font-size: 12px;text-decoration: underline !important;" title="onlyShopownerForm" data-toggle="modal" data-target="#orangeModalSubscription" class="onlyShopownerForm">
                                (Cick here for shop owner)
                            </a>
                            <a v-else style="color:#780116 !important;font-size: 12px;text-decoration: underline !important;" title="onlyShopownerForm" data-toggle="modal" data-target="#orangeModalSubscription" class="onlyShopownerForm">
                                (Cick here for shop owner)
                            </a>
                        </div>
                    </div>
