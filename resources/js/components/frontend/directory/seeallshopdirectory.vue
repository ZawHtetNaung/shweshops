  ...
  >
    <div class="directory-banner">
      <div class="sn-dir-banner">
        ...
        <div class="sn-dir-search container-fluid d-flex flex-column flex-md-row justify-content-center align-items-center rounded pe-md-0">
          ...
          <select 
            ...
            id="sn-dir-township" 
            class="form-control align-items-center border-0 mb-2 mb-md-0 rounded-0 shadow-none" placeholder="Eg. North Dagon"
          >
            <option value="0" class="" selected>All Township</option>
            <option v-for="township in this.townships" :key="township.key" :value="township.id">
    ...
    <div class="px-md-3">
      ...
      <div id="main-content" class="mt-5 elementor-element elementor-element-3205fef1 elementor-widget elementor-widget-heading px-4 px-md-5">
                ...
                >
                    ...
                    >
                        <div class="images post-img sop-img shop-img position-relative pt-1">
                            <div class="kanok-frame" v-if="shop.shweshops_premium_status=='yes'">
                              <a :href="shop.shweshops_premium_status ? host + '/' + shop.shop_name_url : host + '/directory/detail/' + [shop.shop_name_url ? shop.shop_name_url.split(' ').join('') : shop.shop_name.split(' ').join('')]">
                                <img
                            ...
                            <div class="d-none" v-if="shop.shweshops_premium_status=='yes'">
                              <div class="sn-premium-ribbon text-center">
                              </div>
                            ...
                            <a :href="shop.shweshops_premium_status ? host + '/' + shop.shop_name_url : host + '/directory/detail/' + [shop.shop_name_url ? shop.shop_name_url.split(' ').join('') : shop.shop_name.split(' ').join('')]">
                                ...
                                />
                                <div v-else>
                                  <i class="fas fa-store-alt sn-image-w-h sn-shop-image sn-dir-store"></i>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="post-info px-2">
                      <header class="entry-header">
                          ...
                          <div class="sn-directory-title">
                            <h3 class="yk-product-title">
                              <a class="sop-font-content mt-1"  :href="shop.shweshops_premium_status ? host + '/' + shop.shop_name_url : host + '/directory/detail/' + [shop.shop_name_url ? shop.shop_name_url.split(' ').join('') : shop.shop_name.split(' ').join('')]"
                                  style="font-family: sans-serif !important">{{ shop.shop_name }}</a>
                            </h3>
                            <img v-if="shop.shweshops_premium_status" :src="host + '/images/logo/favicon.gif'" alt="">
                          </div>
                      ...
                      <div class="shop-dir-links">
                        <a :href="shop.facebook_link" :class="shop.facebook_link ? '' : 'grey-out'" style="flex-grow: 1;"><i class="fa-brands fa-facebook"></i></a>
                        <a :href="shop.website_link" :class="shop.website_link ? '' : 'grey-out'" style="flex-grow: 1;"><i class="fa-solid fa-globe"></i></a>
                        <div style="flex-grow: 15;text-align:right;"><a :href="shop.shweshops_premium_status ? host + '/' + shop.shop_name_url : host + '/directory/detail/' + [shop.shop_name_url ? shop.shop_name_url.split(' ').join('') : shop.shop_name.split(' ').join('')]">More Detail</a></div>
