                          ...
                          <div class="row">
                               <div class="col-5">
                                ...
                                <div class="col-6">
                                 ...
                                 <input type="text" class="form-control" name="out_outprice_14_2" id="out_outprice_14_2" value="<?php echo explode('/',$assign_gold_price->outprice_14_2)[0]; ?>" readonly>
                                 </div>
                                 <div class="col-6">
                                 <label for="inprice_14_2" class="col-form-label">အတွင်းစပ် ၁၄ပဲ ၂ ပြားရည်စျေး</label>
                                 <input type="text" class="form-control" name="out_inprice_14_2" id="out_inprice_14_2" value="<?php echo explode('/',$assign_gold_price->inprice_14_2)[0]; ?>" readonly>
                                 </div>
                                <div class="col-6">
                             ...
                             <div class="col-6">
                               ...
                               <div class="offset-2 col-5">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="col-6">
                                        <label for="outprice_14_2" class="col-form-label">အပြင်စပ် ၁၄ပဲ ၂ ပြားရည်စျေး</label>
                                        <input type="text" class="form-control" name="outprice_14_2" id="outprice_14_2" value="<?php echo explode('/',$assign_gold_price->outprice_14_2)[1]; ?>" readonly>
                                    </div>
                                    <div class="col-6">
                                     <label for="inprice_14_2" class="col-form-label">အတွင်းစပ် ၁၄ပဲ ၂ ပြားရည်စျေး</label>
                                     <input type="text" class="form-control" name="inprice_14_2" id="inprice_14_2" value="<?php echo explode('/',$assign_gold_price->inprice_14_2)[1]; ?>" readonly>
                                    </div>
                                    <div class="col-6">
                                    <label for="outprice_13" class="col-form-label">အပြင်စပ် ၁၃ ပဲရည်စျေး</label>
