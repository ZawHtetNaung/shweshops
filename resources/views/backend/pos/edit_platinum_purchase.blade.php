                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <span class="offset-5  mt-2 font-weight-bold" style="font-size:19px;">Create Purchase Form (ရွှေ)</span> --}}
                         <form action="{{route('backside.shop_owner.pos.update_ptm_purchase',$purchase->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-7">
                                    <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;​ပလက်တီနမ်စာရင်းပြင်ဆင်ခြင်း်း</h4>
                           ...
                           <div class="row">
                            <div class="col-7">
                                <span class="text-color" style="font-size:19px;">​ပလက်တီနမ်အထည်အ​ကြောင်းများ</span>
                            </div>
                            <div class="col-5">
                                <span class="text-color" style="font-size:19px;">​ပလက်တီနမ်​စျေးနှုန်းတွက်ချက်ခြင်း</span>
                            </div>
                          </div>
                         <div class="row mt-5">
                            ...
                            <div class="col-3 form-group">
                                <label for="ptm_type">ပလက်တီနမ်အမျိုးအစား</label>
                                <input type="text" name="ptm_type" class="form-control" value="{{$purchase->platinum_type}}">
                            </div>
                            <div class="col-3 form-group">
                            ...
                            <div class="col-3" hidden>
                                <input type="text" name='ptm_price' id='ptm_price' value="{{$purchase->platinum_price}}">
                            </div>
                            ...
                            <div class="image-upload-wrap col-6 py-3">
                                ...
                                <div class="drag-text">
                                  <h6 class="mt-3"><img src="{{asset('/pos/platinumpurchase_photo/'.$purchase->photo)}}"  style="max-height: 100px;" id="preview-image-before-upload">ပုံ​ရွေးရန်</h6>
                                </div>
                            </div>
                            <div class="offset-1 col-5">
                                <div class="row mt-3">
