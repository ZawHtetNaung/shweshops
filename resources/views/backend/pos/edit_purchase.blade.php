                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <span class="offset-5  mt-2 font-weight-bold" style="font-size:19px;">Create Purchase Form (ရွှေ)</span> --}}
                         <form action="{{route('backside.shop_owner.pos.update_purchase',$purchase->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-7">
                                    <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;​ရွှေထည်စာရင်းပြင်ဆင်ခြင်း</h4>
                         ...
                         <div class="row mt-5">
                            ...
                            <div class="image-upload-wrap col-6 py-3">
                                ...
                                <div class="drag-text">
                                  <h6 class="mt-3"><img src="{{asset('/pos/goldpurchase_photo/'.$purchase->photo)}}"  style="max-height: 100px;" id="preview-image-before-upload">ပုံ​ရွေးရန်</h6>
                                </div>
                            </div>
                            ...
                            <div class="offset-1 col-5">
                                <div class="row mt-1">
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="number" name="gold_fee" class="form-control" id="gold_fee"  value="{{$purchase->gold_fee}}">
                                    </div>
                                    <div class="col-6 form-group">
