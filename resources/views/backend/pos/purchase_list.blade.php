        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row d-flex">
                    ...
                    <a class="btn btn-m btn-color ml-3" href="{{route('backside.shop_owner.pos.create_purchase')}}">
                            ...
                            <tbody class="text-center" id="filter">
                                ...
                                <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="{{route('backside.shop_owner.pos.edit_purchase',$purchase->id)}}" class="ml-2 text-warning"><i class="fa fa-pencil" ></i></a>
                                    ...
                                    <a href="{{route('backside.shop_owner.pos.edit_purchase',$purchase->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></a>
         ...
         function goldtypefilter(val){
            ...
            success:function(data){
                ...
                $.each(data.data, function(i, v) {
                    var url1 = '{{ route('backside.shop_owner.pos.edit_purchase', ':purchase_id') }}';
