                                    ...
                                    <div class="d-flex justify-content-end my-3 align-items-center">
                                      <div class="form-group mr-md-2">
                                        <fieldset>
                                          ...
                                          <input type="text" id='search_fromdate_muldisact' class="muldisactdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                        </fieldset>
                                      </div>
                                      <div class="form-group mr-md-2">
                                        <fieldset>
                                          <legend>To Date</legend>
                                          <input type="text" id='search_todate_muldisact' class="muldisactdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                        </fieldset>
                                      </div>
                                      <div class="pr-md-4">
                                        <input type='button' id="muldisact_search_button" value="Search" class="btn bg-info"  >
                                      </div>
                                    </div>
      ...
      $(document).ready(function() {
          ...
          var multipleDiscountActivityTable = $('#multipleDiscountActivityTable').DataTable({
              ...
              ajax: {
                  ...
                  'data': function (data) {
                      // Read values
                      var from_date = $('#search_fromdate_muldisact').val() ? $('#search_fromdate_muldisact').val() + " 00:00:00" : null;
                      var to_date = $('#search_todate_muldisact').val() ? $('#search_todate_muldisact').val() + " 23:59:59" : null;
