                                    ...
                                    <div class="d-flex justify-content-end my-3 align-items-center">
                                      <div class="form-group mr-md-2">
                                        <fieldset>
                                          ...
                                          <input type="text" id='search_fromdate_mulperact' class="mulperactdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                        </fieldset>
                                      </div>
                                      <div class="form-group mr-md-2">
                                        <fieldset>
                                          <legend>To Date</legend>
                                          <input type="text" id='search_todate_mulperact' class="mulperactdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                        </fieldset>
                                      </div>
                                      <div class="pr-md-4">
                                        <input type='button' id="mulperact_search_button" value="Search" class="btn bg-info"  >
                                      </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table id="multipleDamageActivityTable" class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <th>အထည်ပျက်စီးချို့ယွင်း(new)</th>
