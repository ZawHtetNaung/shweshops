                                    ...
                                    @foreach ($items->slice(0, 6) as $item)
                                        <tr class="">
                                            <td class="" style="font: 'myanmar3">
                                                <img class="sop-image-table" src="{{ url($item->CheckPhotothumbs) }}" alt=""><br
                                            ...
                                            @else
                                                <td class="">{{\Illuminate\Support\Str::limit( $item->UserName , 10, '..')}}</td>
                                            @endif
                        ...
                        <ul class="list-group mb-3">
                            ...
                            @foreach($managers->slice(0, 5) as $manager)
                                <li class="list-group-item d-flex justify-content-between">
                                    <div style="width: 70%;text-transform:capitalize;"><p
                                            class="font-weight-bold"> {{\Illuminate\Support\Str::limit($manager->name, 10, '..')}}</p>
                                    </div>

                                    <div style="width: 30%;text-transform:capitalize;"><p>{{$manager->role->name}}</p>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            @isset(Auth::guard('shop_owner')->user()->id)
                                                <a href="{{route('backside.shop_owner.edit')}}"
                                                   class="btn btn-primary btn-block"><b><span class="fa fa-edit"></span>&nbsp;&nbsp;Edit</b></a>
                                            @endisset
                                            ...
                                            @isset(Auth::guard('shop_owner')->user()->id)
                                                <a href="{{route('backside.shop_owner.change.password')}}"
                                                   class="btn btn-primary btn-block"><b><span class="fa fa-lock"></span>&nbsp;&nbsp;Edit</b></a>
                                            @endisset
                                        </div>
                                    </div>
