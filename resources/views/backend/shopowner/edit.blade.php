                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 pt-3 ps-3">
                            ...
                            <p>ဆိုင်အတွက်လိုအပ်သည့်အချက်အလက်များကိုထည့်သွင်းနိုင်ပါသည်<p>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                            ...
                            <div class="row sn-item-create-wrapper">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="name" placeholder="Enter shop name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <fieldset>
                                            <legend><span style="font-family: 'Myanmar3'!important"> ဆိုင်အမည် </span>( In MM )</legend>
                                        {{-- <label for="shopname">ဆိုင် အမည် ( In MM )</label> --}}
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="name" placeholder="ဆိုင်အမည် ထည့်ရန်"
                                               name="shop_name_myan" value="{{ old('name',$shopowner->shop_name_myan) }}" >
                                        </fieldset>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="Name" placeholder="ဆိုင်ပိုင်ရှင် နာမည်"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{-- <label for="title">Title</label> --}}
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="shopNameUrl" placeholder="Shop name url"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="name" placeholder="Enter Main Phone"
                                               name="main_phone" value="{{ old('main_phone',$shopowner->main_phone) }}" >
                                        @error('main_phone')
                                        <x-error>
                                            {{$message}}
                                        </x-error>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <fieldset class="sop-texarea">
                                            ...
                                            <textarea id="summernoteAddress"  rows="5" name="address" >{{ old('address',$shopowner->address) }}</textarea>
                                        </fieldset>
                                        @error('address')
                                        <x-error>
                                            {{$message}}
                            ...
                            <div class="row sn-item-create-wrapper">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea  id="summernoteDescription" @focus="$event.target.select()" class="form-control sop-form-control" name="description" rows="3"
                                                  placeholder="Enter ...">{{$shopowner->description}}</textarea>
                                        @error('description')
                                        <x-error>
                                            {{$message}}
                                        </x-error>
                            ...
                            <div class="row sn-item-create-wrapper">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="phone_no" placeholder="Enter Page Link"
                                               name="page_link" value="{{ old('page_link',$shopowner->page_link) }}" >
                                        @error('page_link')
                                        <x-error>
                                            {{$message}}
                                        </x-error>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input @focus="$event.target.select()" type="text" class="form-control sop-form-control" id="name" placeholder="Enter Messenger Link"
                                               name="messenger_link" value="{{ old('messenger_link',$shopowner->messenger_link) }}" >
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input @focus="$event.target.select()" type="file" name="shop_logo" class="custom-file-input"
                                                               id="exampleInputFile">
                                        ...
                                        <div class="col-md-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="exampleInputFile">Bannerတင်ရန်</label>

                                                    <input @focus="$event.target.select()" type="file" name="banner[]" multiple placeholder="ဆိုင်bannerတင်ရန်" class="custom-file-input"
                                                        id="exampleInputFile">
                                                </div>
