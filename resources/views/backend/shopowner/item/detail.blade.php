                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <h1 class="product_title entry-title sn-product-title">{{$item->name}}<span
                                                class="zh-pc" style="color:grey;"> ({{$item->product_code}})</span></h1>
                                            ...
                                            <div class="sn-accordion-item">
                                                ...
                                                <div class="sku-wrapper product_meta sn-accordion-content">
                                                    ...
                                                    @if($item->weight_unit != '0')
                                                        ...
                                                        <div class="zh-row row">
                                                            <div class="col-6">
                                                                <span class="font-red sn-detail-title " style="">အလေးချိန်</span>
                                                            </div>
                                                            <div class="col-6">
                                                                <?php
                                                    ...
                                                    <div class="zh-row row">
                                                        ...
                                                        <div class="col-6 d-flex align-items-center">
                                                            @switch( $item->gender)
                                                                ...
                                                                @break
                                                                @case("UniSex")
                                                                <i class="fa-solid fa-genderless px-1"
                                                                   aria-hidden="true"
                                                ...
                                                <div class="sku-wrapper product_meta sn-accordion-content" style="">
                                                    ...
                                                    <div class="zh-row row">
                                                        ...
                                                        <div class="col-4 ">
                                                          <span class="sku"
                                                                itemprop="sku">
                                                               @if(empty($item->charge))@else{{$item->charge}}@endif</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="zh-row row">
                                                        <div class="col-8 ">
                                                            <span class="sn-detail-title font-red">တန်ဖိုးမြင့်အထည်နှင့် အထည်မပျက်ပြန်လဲ</span>
                                                        </div>
                                                        <div class="col-4 ">
                                                            <span class="sku"
                            ...
                            <div class="row">
                                ...
                                @else
                                    <a href="javascript:void(0);"
                                       class="btn btn-md btn-info" onclick="unsetDiscount()"><i
                                            class="fa-solid fa-percent"></i>&nbsp;&nbsp;Unset Discount</a>&nbsp;
                                    <form id="unset"
