                                    ...
                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <select name="base" class="price-select form-control form-select"
                                                                    id="discountbase">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 ">
                                                            ...
                                                            <input type="number" class="form-control" value="" min="1"
                                                                   name="percent" placeholder="Enter Discount Percent"
                                                                   required step="0.1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 ">
                                                            ...
                                                            <input type="number" id="pricetominus" class="form-control"
                                                                   name="price" placeholder="Enter Discount Price"
                                                                   required step="0.1">
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    @else
                                                        <div class="row">
                                                            <div class="col-12 exact no-gutters sop-font">
                                                                <label>သင့် product စျေးနှုန်းသည်  <span id="percentforshow"></span> </label>
                                                ...
                                                <input type="hidden" name="percentbyprice" value="" class="form-control">
        ...
        $(document).ready(function () {
            ...
            if ($('#old_exact_price').text()) {
                ...
                percent.on('keyup', function () {
                    var calculated_price = (percent.val() == '' || percent.val() == '0') ? '' : old_exact_price - (old_exact_price * percent.val() / 100);
                ...
                exact_price.on('keyup', function () {
                    var calculated_percent = (exact_price.val() == '') ? '' : (old_exact_price - exact_price.val()) * 100 / old_exact_price;
                ...
                percent.on('keyup', function () {
                    var calculated_min_price = (percent.val() == '' || percent.val() == '0') ? '' : old_min_price - (old_min_price * percent.val() / 100);
                    var calculated_max_price = (percent.val() == '' || percent.val() == '0') ? '' : old_max_price - (old_max_price * percent.val() / 100);
                     if(calculated_min_price < 0){
                         ...
                         showpricemyanmarforminmax(Math.round(calculated_min_price),Math.round(calculated_max_price))
                     }
