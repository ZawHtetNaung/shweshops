                            ...
                            <div class="sn-table-list-wrapper">
                                ...
                                <div class="card shadow-none border-0 rounded-5">
                                  <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                      <form action="{{url('backside/shop_owner/multipe_unset_discount')}}" method="post">
                                        @csrf

                                        <input type="hidden" name="unsetItems" value="" class="unsetDiscountItems">
                                        <button type="submit" class="btn btn-danger multiple_unset_btn ml-2" onclick="return confirm('Are You Sure To Unset?')"> Unset Discount</button>
                                      </form>
                                    </div>
                                  </div>
            ...
            columns: [
              ...
              },
              {
                ...
                render: function(data, type,row) {
                    console.log(row);
                  var discountButton = `<button type="button" onclick="Delete(${data})" class="btn btn-block bg-gradient-danger btn-sm">Unset Discount</button>`;
                  var deleteFunction = `
