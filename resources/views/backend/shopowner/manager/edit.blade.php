                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                                   placeholder="Enter name" required  value="{{$manager->name}}"/>
                                                   @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                                                   placeholder="Enter Phone-no" required value="{{$manager->phone}}"/>
                                                   @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @foreach($role as $role)
                                                <option value="{{$role -> id}}" {{$manager->role_id == $role->id ? 'selected' : ''}}>
                                                   {{$role -> name}}
                                                </option>
                                            @endforeach
