    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if(data.new_name != null && data.new_name != "no") {
          document.getElementById("userName").textContent = "from " + data.old_name+ " to " + data.new_name;
        ...
        if(data.new_phone != null && data.new_phone != "no") {
          document.getElementById("userPhone").textContent = "from " + data.old_phone+ " to " + data.new_phone;
        ...
        if(data.new_role_id != null && data.new_role_id != "no") {
          document.getElementById("userRole").textContent = "from " + data.old_role_id+ " to " + data.new_role_id;
