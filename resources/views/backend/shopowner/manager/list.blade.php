                            ...
                            <tbody>
                              ...
                              @foreach($manager as $manager)
                                  <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="{{route('backside.shop_owner.managers.detail',$manager->id)}}"><span class="fa fa-info-circle"></span></a>
                                    <a class="btn btn-sm btn-primary" href="{{route('backside.shop_owner.managers.edit',$manager->id)}}"><span class="fa fa-edit"></span></a>  </td>
                                  </tr>
                              @endforeach
                            </tbody>
                            <tfoot>
