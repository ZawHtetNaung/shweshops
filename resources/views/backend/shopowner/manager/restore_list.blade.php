                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="sn-table-list-wrapper">
                                ...
                                <a href="{{ route('backside.shop_owner.managers.restore_list') }}" class="btn btn-success">Restore All</a>
                                @endif
                                </div>
                                <!-- /.card-header -->
                                     ...
                                     <table id="datatable" class="table table-borderless mb-2">
                                        ...
                                        @foreach($manager as $manager)
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{ route('backside.shop_owner.managers.restore', $manager->id) }}" class="btn btn-success">Restore</a>
                                                </td>
