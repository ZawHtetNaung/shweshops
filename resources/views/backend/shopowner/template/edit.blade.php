                ...
                <div class="card-body">
                    <form>
                      <div class="row g-3 align-items-center mb-3">
                          ...
                          <div class="col-12">
                            <input type="text" min=0 class="form-control" name="name" id="a-1" value="{{ $template->name }}" >
                          </div>                           
                      </div>
                        ...
                        <div class="row g-3 align-items-center mb-3">
                            ...
                            <div class="col-12">
                               <input type="text" min=0 class="form-control" name="အထည်မပျက်ပြန်သွင်း" id="a-2" value="{{ $template->undamage_product}}">
                            </div>                           
                        </div>
                        <div class="row g-3 align-items-center mb-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                               <input type="text" min=0 class="form-control" name="အထည်ပျက်စီးချို့ယွင်း" id="a-3" value="{{ $template->damage_product}}" >
                            </div>                           
                        </div>
                        <div class="row g-3 align-items-center mb-3">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                               <input type="text" min=0 class="form-control" name="တန်ဖိုးမြင့်" id="a-4" value="{{ $template->valuable_product}}" >
                            </div>                           
                        </div>
                    </form>
