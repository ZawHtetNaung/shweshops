                              ...
                              <div class="d-flex justify-content-end my-3 align-items-center">
                                <div class="form-group mr-md-2">
                                  <fieldset>
                                    ...
                                    <input type="text" id='search_fromdate_adminsact' class="admindatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                  </fieldset>
                                </div>
                                <div class="form-group mr-md-2">
                                  <fieldset>
                                    <legend>To Date</legend>
                                    <input type="text" id='search_todate_adminsact' class="admindatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                                  </fieldset>
                                </div>
                                <div class="pr-md-4">
                                  <input type='button' id="adminsact_search_button" value="Search" class="btn bg-info"  >
                                </div>
                              </div>
  ...
  <script>
      var superAdminActivityTable = $('#superAdminTable').DataTable({
          ...
          ajax: {
              ...
              'data': function(data){
                  // Read values
                  var from_date = $('#search_fromdate_adminsact').val() ? $('#search_fromdate_adminsact').val() + " 00:00:00" : null;
                  var to_date = $('#search_todate_adminsact').val() ? $('#search_todate_adminsact').val() + " 23:59:59" : null;
    ...
    $('#adminsact_search_button').click(function(){
      if($('#search_fromdate_adminsact').val() != null && $('#search_todate_adminsact').val() != null) {
