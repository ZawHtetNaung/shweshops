        ...
        $(document).ready(function () {
            var adsActivityTable = $('#superAdminTable').DataTable({
                ...
                ajax: {
                    ...
                    'data': function (data) {
                        // Read values
                        var from_date = $('#search_fromdate_adsact').val() ? $('#search_fromdate_adsact').val() + " 00:00:00" : null;
                        var to_date = $('#search_todate_adsact').val() ? $('#search_todate_adsact').val() + " 23:59:59" : null;
