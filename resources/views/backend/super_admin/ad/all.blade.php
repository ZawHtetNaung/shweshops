                            ...
                            <div class="sn-table-list-wrapper pb-2 mt-5">
                                ...
                                <div class="card shadow-none border-0 rounded-5 p-2">
                                    ...
                                    <div class="d-flex justify-content-end my-3 align-items-center">
                                        ...
                                        <div class="pr-md-4">
                                            <input type='button' id="ads_search_button" value="Search"
                                                   class="btn bg-info">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#adsact_search_button').click(function () {
                if ($('#search_fromdate_adsact').val() != null && $('#search_todate_adsact').val() != null) {
        ...
        var adsTable = $('#superAdminTable').DataTable({
            ...
            ajax: {
                ...
                'data': function (data) {
                    // Read values
                    var from_date = $('#search_fromdate_ads').val() ? $('#search_fromdate_ads').val() + " 00:00:00" : null;
                    var to_date = $('#search_todate_ads').val() ? $('#search_todate_ads').val() + " 23:59:59" : null;
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        console.log(row)
                        if (row.video !== null) {
                            var result = row.deleted_at ? `<img src="{{asset('images/banner/video/${row.video}')}}" class="filter cover" alt="cover" >` : `<img src="{{asset('images/banner/video/${row.video}')}}" alt="cover" class="cover" >`;

                        } else {
                            var result = row.deleted_at ? `<img src="{{asset('images/banner/${data}')}}" class="filter cover" alt="cover" >` : `<img src="{{asset('images/banner/${data}')}}" alt="cover" class="cover" >`;
                        }
