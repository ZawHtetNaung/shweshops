              ...
              <div class="col-12 col-lg-6">
                <div class="card card-outline card-primary p-0">
                    ...
                    <div class="card-body p-lg-3 p-2">
                      ...
                      <div class="video">
                          <form action="{{ url('backside/super_admin/ads_video')}}" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="form-group">
                                  <label id="shop">Image</label>

                                  <input type="file"  name="video" id="" class="form-control  @error('video')
                                      is-invalid
@enderror">
                              </div>
                              <div class="form-group mb-lg-4">
                                      <div class="p-0">
                                          ...
                                          <select class="form-control selectVideo @error('shop_id')
                                            is-invalid
                                          @enderror" style="width: 100%;" id="shop"  name="shop_id">
                                              <option value="">Choose</option>
                                              @foreach ($shops as $shop )
                                                  <option value="{{ $shop->id }}">{{ $shop->shop_name }} ( {{$shop->shop_name_myan}} )</option>
                                              @endforeach
                                          </select>
                                          @error('shop_id')
                                            <span class="text-danger font-weight-bolder"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span>
                                          @enderror
                                      </div>
                              ...
                              <div class="col-6">
                                  ...
                                  <div class="input-group date" id="startVideo" data-target-input="nearest">
                                      <input type="text" name="start" class="form-control datetimepicker-input @error('start')
                                        is-invalid
                                      @enderror" data-target="#startVideo"/>
                                      <div class="input-group-append" data-target="#startVideo" data-toggle="datetimepicker">
                              ...
                              <div class="col-6">
                                  ...
                                  <div class="input-group date" id="endVideo" data-target-input="nearest">
                                      <input type="text" name="end" class="form-control datetimepicker-input @error('end')
                                        is-invalid
                                      @enderror" data-target="#endVideo"/>
                                      <div class="input-group-append" data-target="#endVideo" data-toggle="datetimepicker">
                                          <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                      </div>
                                  </div>
                                  @error('end')
