...
@enderror">
                                    ...
                                    <div class="form-group mb-lg-12">
                                        <div class="p-0">
                                            ...
                                            @foreach ($shops as $shop )
                                                    <option
                                                        value="{{ $shop->id }}" {{ $ad->shop_id == $shop->id ? 'selected' : '' }}>{{ $shop->shop_name }}
                                                        ( {{$shop->shop_name_myan}} )
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="links" value="{{ $ad->links }}" class="form-control" id="linkUrl">
                                    </div>
                                    <div class="form-row mb-4">
                                        <div class="col-6">
                                            <label for="start">Start</label>
                                            <p>{{ Carbon::createFromFormat('Y-m-d H:i:s',$ad->start)->format('d M Y (h:i A)')}}</p>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p>{{ Carbon::createFromFormat('Y-m-d H:i:s',$ad->end)->format('d M Y (h:i A)')}}</p>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <a href="{{ route('backside.super_admin.ads.index')}}" class="btn btn-dark">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
