...
@section('title','MOE Admin Team | Buy Now List')
@section('content')
<style>
                      ...
                      <div class="d-flex justify-content-end my-3 align-items-center">
                        <div class="form-group mr-md-2">
                            <fieldset>
                              ...
                              <input type='text' id='search_fromdate_buynow' class="buynowdatepicker form-control" placeholder='Choose date' autocomplete="off">
                            </fieldset>
                          </div>
                          <div class="form-group mr-md-2">
                            <fieldset>
                              <legend>To Date</legend>
                              <input type='text' id='search_todate_buynow' class="buynowdatepicker form-control" placeholder='Choose date' autocomplete="off">
                            </fieldset>
                          </div>
                          <div class="pr-md-4">
 ...
 <script>
     var buyNowCountTable = $('#buyNowCountTable').DataTable({
         ...
         ajax: {
             ...
             'data': function (data) {
                 // Read values
                 var from_date = $('#search_fromdate_buynow').val() ? $('#search_fromdate_buynow').val() + " 00:00:00" : null;
                 var to_date = $('#search_todate_buynow').val() ? $('#search_todate_buynow').val() + " 23:59:59" : null;
    ...
    $('#buynow_search_button').click(function(){
      if($('#search_fromdate_buynow').val() != null && $('#search_todate_buynow').val() != null) {
