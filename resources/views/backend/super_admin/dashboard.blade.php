            ...
            <section class="content">
                ...
                <div class="ml-2 ml-lg-4">
                  <div class="d-flex flex-wrap align-items-stretch justify-content-start">
                    <div class="sn-card"
                          style="background-color: #4E73F8;color: white;">
                        ...
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Website Viewer</h5>
                                <p class="card-text" id="viewer" style="
                                    font-size: 2.1rem;
                                ">{{ count($viewer) }}</p>
                            </a>
                        </div>
                    ...
                    <div class="sn-card"
                          style="background-color: #f84e4e;color: white;">
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Ads View</h5>
                                <p class="card-text" id="adsview" style="
                                    font-size: 2.1rem;
                                ">{{ count($adsview) }}</p>
                            </a>
                        </div>
                    ...
                    <div class="sn-card"
                          style="background-color:#6ddb09;color: white;">
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Shops</h5>
                                <p class="card-text" id='shop' style="
                                    font-size: 2.1rem;
                                ">{{ count($shop) }}</p>
                            </a>
                        </div>
                    ...
                    <div class="sn-card"
                          style="background-color: #e64ef8;color: white;">
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Shops Viewer</h5>
                                <p class="card-text" id='shopview' style="
                                    font-size: 2.1rem;
                                ">{{ count($shopview) }}</p>
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Buy Now</h5>
                                <p class="card-text" id='buynow'  style="
                                    font-size: 2.1rem;
                                ">{{ count($buynow) }}</p>
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Add To Cart</h5>
                                <p class="card-text" id='addtocart' style="
                                    font-size: 2.1rem;
                                ">{{ count($addtocart) }}</p>
                            </a>
                        </div>
                        ...
                        <div class="card-body">
                            <a href="" style="color: #ffffff;">
                                <h5 class="card-title" style="
                                    font-size: 1.3rem;
                                ">Whishlist</h5>
                                <p class="card-text" id='whishlist' style="
                                    font-size: 2.1rem;
                                ">{{ count($whishlist) }}</p>
                            </a>
                        </div>
                          ...
                          <div class="card-body">
                              <a href="" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Website Viewer</h5>
                                  <p class="card-text" id='uqviewer' style="
                                      font-size: 2.1rem;
                                  ">{{ count($uqviewer) }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Ads View</h5>
                                  <p class="card-text" id='uqadsview'  style="
                                      font-size: 2.1rem;
                                  ">{{ count($uqadsview) }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Shops Viewer</h5>
                                  <p class="card-text" id='uqshopview' style="
                                      font-size: 2.1rem;
                                  ">{{ count($uqshopview) }}</p>
                              </a>
                          </div>
                      ...
                      <div class="sn-card"
                          ...
                          <div class="card-body">
                              <a href="" style="color: #ffffff;">
                                  ...
                                  <p class="card-text" id='registercount' style="font-size: 2.1rem;
                                  ">{{ count($register) }}</p>
                              </a>
                          </div>
                      </div>
                          ...
                          <div class="card-body">
                              <a href="" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Buy Now</h5>
                                  <p class="card-text" id='uqbuynow' style="
                                      font-size: 2.1rem;
                                  ">{{ count($uqbuynow) }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{route('visitorcount.all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Website Viewer</h5>
                                  <p class="card-text" id='allviewers' style="
                                      font-size: 2.1rem;
                                  ">{{ $allviewers }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{route('adscount.all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Ads View</h5>
                                  <p class="card-text" id='alladsviewers' style="
                                      font-size: 2.1rem;
                                  ">{{ $alladsviewers }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{route('shopviewercount.all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Shops Viewer</h5>
                                  <p class="card-text" id='allshopviewers' style="
                                      font-size: 2.1rem;
                                  ">{{ $allshopviewers }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{route('buynowcount.all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Buy Now</h5>
                                  <p class="card-text" id='allbuynow' style="
                                      font-size: 2.1rem;
                                  ">{{ $allbuynow }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{url('backside/super_admin/addtocartcount/all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Add To Cart</h5>
                                  <p class="card-text"  id='alladdtocart' style="
                                      font-size: 2.1rem;
                                  ">{{ count($addtocart) }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a href="{{url('backside/super_admin/wishlistcount/all')}}" style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">Whishlist</h5>
                                  <p class="card-text" id='allwhishlist' style="
                                      font-size: 2.1rem;
                                  ">{{ count($whishlist) }}</p>
                              </a>
                          </div>
                          ...
                          <div class="card-body">
                              <a style="color: #ffffff;">
                                  <h5 class="card-title" style="
                                      font-size: 1.3rem;
                                  ">New Users</h5>
                                  <p class="card-text" id='newusers' style="
                                      font-size: 2.1rem;
                                  ">{{ $newusers }}</p>
                              </a>
                          </div>
