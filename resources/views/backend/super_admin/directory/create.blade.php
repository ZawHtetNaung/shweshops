                        ...
                        <form  method="POST" enctype="multipart/form-data"
                            ...
                            <div class="se form-group row"> --}}
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="main_phone" value="{{ old('website_link') }}"
                                               min="0" type="text" type="text"
                            ...
                            <div class="se form-group row">
                              ...
                              <div class="col-12 col-md-6" >
                                ...
                                <input type="hidden" id="state" name="state" value="{{ old('state') ? old('state') : '[]' }}">
                              ...
                              <div class="col-12 col-md-6" >
                                ...
                                <input type="hidden" id="township" name="township" value="{{ old('township') ? old('township') : '[]' }}">
                            ...
                            <div class="se form-group row">
                                ...
                                <button id="createDirectoryButton" type="submit" class="btn btn-primary float-right">
                                    {{ __('Create') }}
                                </button>
                                </div>
        ...
        $("#createDirectoryButton").on("click", function(e) {
          ...
          $.ajax({
              ...
              success: function (response) {
                if(response.isExit) {
                  if ( confirm("Shweshops has the same name. Do you want to continue?") == false ) {
                      return false ;
                  } else {
