                                ...
                                <div class="card shadow-none card-outline card-primary rounded-5 pb-2 mt-5">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{ url('backside/super_admin/directory/all') }}"> <i class="fas fa-list"></i></a>
                                        </div>
                                    </div>
                                    <div class="card-body p-lg-5">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Logo</label>
                                            <div><img src="{{url('images/directory/'.$ttdata->shop_logo)}}" style="width: 222px;"></div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div><a href="{{$ttdata->facebook_link}}">{{$ttdata->facebook_link}}</a></div>
