    ...
    <div class="wrapper">
        ...
        <section class="content-wrapper">
            ...
            <section class="content-header">
                <x-title>Edit Shop Directory</x-title>
            </section>
            <div class="container">
                <div class="row">
                    ...
                    <div id="" class="col-12">
                        ...
                        <form  method="POST" enctype="multipart/form-data"
                               action="{{ url('/backside/super_admin/directory/edit') }}">
                            @csrf

                            <input type="hidden" name='id' value="{{$ttdata->id}}"/>
                            <div class="se form-group row">
                                <div class="col-12 col-md-6">
                                    <label for="exampleInputEmail1">ဆိုင် အမည် <span
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name" type="text"
                                               ...
                                               name="shop_name" value="{{ old('shop_name',$ttdata->shop_name) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="shop_name_myan">ဆိုင် အမည် myanmar<span
                                            style="color: red;">*</span></label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name_myan" type="text"
                                              ...
                                              name="shop_name_myan" value="{{ old('shop_name_myan',$ttdata->shop_name_myan) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="exampleInputEmail1">Shop Url<span
                                            style="color: red;">*</span></label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name_url" type="text"
                                              ...
                                              name="shop_name_url" value="{{ old('shop_name_url',$ttdata->shop_name_url) }}"
                                              placeholder="ဆိုင် အမည်" autocomplete="name" autofocus>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="main_phone" value="{{ old('main_phone',$ttdata->main_phone ) }}"
                                ...
                                <div class="col-12 col-md-6">
                                  <label for="additional_phones">Other Phones<span
                                    style="color: red;"></span></label>
                                  <div class="input-group mb-3">
                                    <input type="text" class=" form-control-tags js-tagify" id="additional_phones" placeholder="Press Enter after each phones"
                                    name="additional_phones" value="{{ old('additional_phones',$ttdata->additional_phones) }}">
                                  </div>
                                </div>
                            ...
                            <div class="se form-group row"> --}}
                                <div class="col-12 col-md-6">
                                    <label for="exampleInputEmail1">Facebook Link<span
                                            style="color: red;"></span></label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name" type="text"
                                               ...
                                               name="facebook_link" value="{{ old('facebook_link',$ttdata->facebook_link) }}"
                                               placeholder="Facebook" autocomplete="name" autofocus>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <!-- <label for="password" class="col-md-4 col-form-label text-md-right">Shop NAME</label> -->
                                    <label for="exampleInputEmail1">Website Link<span
                                            style="color: red;"></span></label>


                                    <div class="input-group mb-3">

                                        <input id="main_phone" value="{{ old('website_link',$ttdata->website_link) }}"
                                               min="0" type="text" type="text"
                                               class="form-control @error('website_link') is-invalid @enderror"
                                               name="website_link" placeholder="Website"
                                               autocomplete="new-password">
                                    </div>
                            ...
                            <div class="se form-group row">
                              <div class="col-12 col-md-6" >
                                ...
                                <input type="hidden" id="state" name="state" value="{{ old('state') ? old('state') : $ttdata->state }}">
                                <div class="sn-multiple-selection">
                                  ...
                                  @elseif ($ttdata->state)
                                    <span>{{ count(json_decode($ttdata->state)) }} state(s) selected</span>
                                  @else
                                  ...
                                  <div class="sn-checkbox-dropdown sn-dropdown-state d-none">
                                    @foreach($states as $state)
                                      @if (in_array($state->id, old('state') ? json_decode(old('state')) : json_decode($ttdata->state) ) )
                                        <div
                                          class="sn-gem-list"
                                        >
                                          <input
                                          ...
                                          />
                                          <label for="{{ $state->id }}_state">{{ $state->name . ' (' . $state->myan_name . ')' }}</label>
                                        </div>
                                      @else
                                        <div
                                          class="sn-gem-list"
                              ...
                              <div class="col-12 col-md-6" >
                                ...
                                <input type="hidden" id="township" name="township" value="{{ old('township') ? old('township') : $ttdata->township }}">
                            ...
                            <div class="se form-group row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <textarea id="address" type="description"
                                              ...
                                              name="address" placeholder="Address" rows="4">{{old('address',$ttdata->address)}}</textarea>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label"
                                               for="exampleInputFile" style="color: #979797;">ဆိုင်logoတင်ရန်</label>

                                    </div> --}}
                                    <div class="custom-file">
                                      <label for="formFile" class="form-label">ဆိုင်logoတင်ရန် <span style="color: red;"></span></label>
                                      <input class="form-control" type="file" id="formFile" name="shop_logo" accept="image/png, image/gif, image/jpeg" >
                                    </div>
...
@push('scripts')
  ...
  <script>
    ...
    function getTownship (township) {
      ...
      var label = "";
      var input = " ";
      township = township ? JSON.parse(township) : JSON.parse($('#township').val()); // has old selected township or not
