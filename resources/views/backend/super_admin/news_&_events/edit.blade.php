                ...
                <div class="col-12">
                    <div class="p-3 ">
                            ...
                            <div class="card-body p-4">
                                    ...
                                    <div class="col-12">
                                        <div class="image_area bg-secondary">
                                                ...
                                                <label for="upload_image" >
                                                    ...
                                                    <img src="{{ asset('images/news/'. $news->image)}}" id="uploaded_image" class="img-responsive" />
                                                    <div class="overlay rounded-0">
                                                        <div class="text">Click to Change Cover Photo</div>
                                                    </div>
                                                    <input type="file" name="photo" class="image" id="upload_image" style="display:none">
                                                </label>
                                ...
                                <label>Promotion Date</label>
                                    <div class="form-row">
                                        <div class="form-group col-6 col-md-2">
                                            ...
                                            <span>{{$news->from}}</span>
                                            <input type="date" class="form-control" name="from" id="from"  placeholder="dd-mm-yyyy" value="{{ $news->from }}">
                                        </div>
                                        <div class="form-group col-6 col-md-2">
                                            <label for="to">To</label><br>
                                            <span>{{ $news->to}}</span>
                                            <input type="date" class="form-control" name="to" id="to" placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <a href="{{route('backside.super_admin.news.index')}}" class="btn btn-outline-dark float-right ml-2">Back</a>
                                <button class="btn btn-primary float-right" id="btn" type="submit"><span class="fa fa-paper-plane"></span>&nbsp;&nbsp;Update </button>
                            </div>      
