                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a href=" {{ route('backside.super_admin.news.create') }} " class="btn btn-primary">Add New</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{route('news.restore',$post->id)}}">
                                                        <button class="btn btn-sm btn-warning">Restore <i class="fas fa-trash-restore"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
