                      ...
                      <form action="{{ url('backside/super_admin/gold_point/create')}}" action="post">
                        @csrf
                            <div class="form-group">
                                ...
                                <input type="number" name="status" class="form-control @error('status')
                                    is-invalid
                                @enderror" id="InputPrice" aria-describedby="emailHelp">
                                @error('status')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('count')
                                    is-invalid
                                @enderror" name="count" id="InputCount">
                                @error('count')
                                  <span class="text-danger font-weight-bolder">{{ $message }}</span>
                                @enderror
                            </div>
