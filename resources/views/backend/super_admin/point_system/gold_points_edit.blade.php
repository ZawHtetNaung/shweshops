                      ...
                      <form action="{{ url('backside/super_admin/gold_point/store')}}" method="post">
                        ...
                        @method('PUT')
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $gold_point->status }}" name="status" class="form-control @error('status')
                                    is-invalid
                                @enderror" id="InputPrice">
                                @error('status')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{ $gold_point->counts }}" class="form-control @error('counts')
                                    is-invalid
                                @enderror" name="counts" id="InputCount">
                                @error('counts')
                                  <span class="text-danger font-weight-bolder">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <a href="{{ url('backside/super_admin/gold_points')}}" role="button" class="btn btn-sm btn-outline-dark">Back</a>
                            </form>
