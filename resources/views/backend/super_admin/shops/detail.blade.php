                    ...
                    <div class="col-lg-8 col-md-6 p-4">
                        ...
                        <div class="d-lg-flex align-items-center justify-content-between mb-5">
                            <div class="d-lg-flex d-md-flex align-items-center">
                                <div class="detail_logo mx-auto">
                                    <img src="{{url('images/logo/'.$shop->shop_logo)}}" alt="" class="rounded-circle">
                                </div>
                        ...
                        <div class="p-4 shadow-sm rounded-3 mb-5">
                            ...
                            <div>
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    <span
                                        class="mm-font">တန်ဖိုးမြင့်အထည် နှင့် အထည်မပျက်ပြန်လဲ : </span>
                                    <span
                                        class="font-weight-bold">{{$shop->တန်ဖိုးမြင့်အထည်_နှင့်_အထည်မပျက်ပြန်လဲ}} %</span>
                                </div>
                                <div class="mb-2 d-flex justify-content-between">
                            ...
                            <form class="option">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 bg-transparent">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="hidden" id="{{$shop->id}}">
                                            <input type="checkbox" name="addToCartClickView"
                                                   class="custom-control-input" id="settingToggle7">
                                            <label class="custom-control-label" id="statusText"
