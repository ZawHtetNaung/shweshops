        ...
        <div class="container-fluid">
            <div class="row mb-4">
                ...
                <div class="col-12 col-md-6 d-flex justify-content-center">
                   <div class=" my-3">
                    <form class="d-flex align-items-center" action="{{route('shops.shopowner_using_chat_date_filter')}}" method="post">
                      @csrf
                      <input type="hidden" name="id" value="{{ $shop_id->id }}">
                      <div class="form-group mr-md-2">
                         <fieldset>
                          <legend>From Date</legend>
                          <input type="text" id='search_fromdate_shop' name="from" class="shopdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                         </fieldset>
                        </div>
                      <div class="form-group mr-md-2">
                         <fieldset>
                          <legend>To Date</legend>
                          <input type="text" id='search_todate_shop' name="to" class="shopdatepicker form-control" placeholder='Choose date' autocomplete="off"/>
                         </fieldset>
                        </div>
                      <div class="pr-md-4">
                        <input type='submit' id="message_search_button" value="Search" class="btn bg-info" style="margin-top: 25px;">
                      </div>
                    </form>
                  </div>
                </div>
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    @if($mg->message_user_id === $m->message_user_id)
                                        @if($mg->type === "text")
                                            @if($mg->from_role === "user")
                                                ...
                                                <div class="chat-info">
                                                    ...
                                                    <span class="direct-chat-timestamp ml-3 mt-1 time-font">{{$mg->created_at->format('d M h:i A')}}</span>
                                                </div>
                                                <!-- /.direct-chat-infos -->
                                                <img class="direct-chat-img" src="{{ asset('images/chat/user-1.png')}}" alt="message user image">
                                                <!-- /.direct-chat-img -->
                                            ...
                                            @elseif($mg->from_role === "shopowner")
                                                <div class="direct-chat-msg right mb-3">
                                                    <div class="d-flex justify-content-end align-items-center">
                                                                <span class="direct-chat-timestamp time-font mr-2">{{$mg->created_at->format('d M h:i A')}}</span>
                                                    <span class="direct-chat-name float-right">Owner</span>
                                                                            
                                    
                                                    </div>
                                                    <!-- /.direct-chat-infos -->
                                                    <img class="direct-chat-img" src="{{ asset('images/chat/user-2.png')}}" alt="message user image">
                                                    <!-- /.direct-chat-img -->
                                                    <div class="position-relative">
                                        ...
                                        @elseif($mg->type === "post")
                                                ...
                                                <!-- /.direct-chat-img -->
                                                <div class="my-direct-chat-text rounded">
                                                    <h3 class="font-weight-bolder text-uppercase">Item !</h3>
                                                </div>
                                                <!-- /.direct-chat-text -->
                                                </div> 
                                        @elseif($mg->type === "image")
                                            ...
                                            @if($mg->from_role === "user")
                                                ...
                                                <!-- /.direct-chat-img -->
                                                <div class="">
                                                <img src="{{ asset('images/chat/'.$image)}}" alt="image" class="w-25 my-2 ml-2 rounded">
                                                </div>
                                                <!-- /.direct-chat-text -->
                                                </div>
                                            ...
                                            @elseif($mg->from_role === "shopowner")
                                                <div class="direct-chat-msg right mb-3">
                                                    ...
                                                    <!-- /.direct-chat-img -->
                                                    <div class="">
                                                    <img src="{{ asset('images/chat/'.$image)}}" alt="image" class="w-25 float-right rounded mr-2 mt-2">
                                                    </div>
                                                    <!-- /.direct-chat-text -->
                                                </div>
                                            @endif
