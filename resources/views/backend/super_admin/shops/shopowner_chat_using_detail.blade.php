                         ...
                         @forelse ($messages_all_users as $m )
                           @foreach($m->UserName as $u)
                              <div class="card direct-chat direct-chat-primary" style="position: relative; left: 0px; top: 0px;">
                                  <div class="card-header ui-sortable-handle chat-title-hight" style="cursor: move;">
                                        <div class="d-flex justify-content-between align-items-center w-100">
                                           ...
                                           <div class="card-tools d-flex aligin-items-center">
                                                <div class="nav-item">
                                                  <a class="nav-link text-black-50" href="#" role="button" onclick="navbarSearch(this)">
                                                    ...
                                                    <div class="form-inline mt-3">
                                                      <div class="input-group input-group-sm">
                                                        ...
                                                        <div class="input-group-append">
                                                          ...
                                                          <button class="btn btn-navbar" type="button" onclick="navbarSearchClose(this)">
                                        ...
                                        @if($mg->message_user_id === $m->message_user_id)
                                            ...
                                            @elseif($mg->type === "post")
                                                  <div class="direct-chat-msg position-relative mb-4">
                                                    ...
                                                    @endphp
                                                        <p> Product Code : {{ print_r($item['product_code'])}}</p>
                                                    </div>
                                                    <!-- /.direct-chat-text -->
                                                  </div> 
