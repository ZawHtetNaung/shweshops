                            ...
                            <div class="card shadow-none border-0 rounded-5 pb-2 mt-5">
                              <div class="card-header">
                                ...
                                <form action="{{route('shops.multiple_delete')}}" method="post">
                                    ...
                                    <input type="hidden" name="deleted_shops" value="" class="deleteShopValue">
                                    <button type="button" class="btn btn-danger multiple_delete_btn ml-2" onclick="multipleDelete(this)"><i class="fa fa-trash"> Multiple Delete</i></button>
                                </form>
                                </div>
                              </div>
                              <!-- /.card-header -->
 ...
 <script>
    ...
    $('#shopTrashTable').DataTable({
        ...
        columns: [
        {
            ...
            return (localRetri.length == 0) ?`<input type="checkbox" value="${data}" id="checkBox" onclick="checkBox(this)">`
            ...
            render: function(data,type,row){
                ...
                if(data == "expired"){
                    var result = `<span class="badge badge-danger">Expired</span>`;
                     ...
                     var result = ` <span class="badge badge-warning">သက်တမ်းကုန်ဆုံးရန် ${row.expired} ရက်သာလိုပါတော့သည်။</span>`;
                }
