    ...
    <div class="sidebar">
        ...
        <nav class="side-menu mt-2">
            <ul class="nav nav-pills nav-sidebar  flex-column nav-flat  " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{url('backside/super_admin')}}" class="mobile-nav nav-link">
...
<!--                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('activity.customer')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>User Activities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('activity.ads')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Ads Activities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('activity.shop')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Shop Activities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('activity.admin')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <!-- zh_ad -->
                <li class="nav-item">
                    <a href="{{route('backside.super_admin.ads.index')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-ad"></i> -->
                        <img id="mobile" class="logo mobile rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Ads.svg'}}" alt=""/>
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Ads.svg'}}" alt=""/>
                        <p>
                            Ads
                            <i class="right fas fa-angle-right"></i>
                            @if ($ads_deleted_count)
                                <span class="badge badge-danger right">{{ $ads_deleted_count }}</span>
                            @endif
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('backside.super_admin.ads.index')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('backside.super_admin.ads.create') }}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('backside/super_admin/fbdata/messenger/list')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
...
{{--                items--}}
                ...
                <li class="nav-item">
                    <a href="{{url('backside/super_admin/items/all')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-store"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Products.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Products.svg'}}" alt=""/>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('backside/super_admin/items/all')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('backside/super_admin/point')}}" class="nav-link border-0">
                ...
                <li class="nav-item">
                    <a href="{{route('backside.super_admin.news.index')}}" class="mobile-nav nav-link">
                        ...
                        <img id="mobile" class="logo d-none mobile  rounded-5" src="{{'/images/logo/super_admin_mobile_logo/News _ Events.svg'}}" alt=""/>
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/News _ Events.svg'}}" alt=""/>
                        <p>
                            News & Event
                            <i class="right fas fa-angle-right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('backside.super_admin.news.create')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">News</p>
                            </a>
                        ...
                        {{--<li class="nav-item">
                                    <a href="{{ route('backside.super_admin.promotion.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Promotions</p>
                                    </a>
                                </li> --}}
                        <li class="nav-item">
                            <a href="{{ route('backside.super_admin.events.create') }}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                ...
                @isset(Auth::guard('super_admin')->user()->id)
                    <li class="nav-item">
                        ...
                        {{-- <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('superAdmin.contactus_get')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Edit</p>
                                </a>
                            </li>
                ...
                {{--Message--}}
                <li class="nav-item">
                    <a href="{{url('backside/super_admin/messages/showexpire')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-comment"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Message.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Message.svg'}}" alt=""/>
                        <p>Message</p>
                    </a>
                </li>
                {{--Using Chat Lists--}}
                <li class="nav-item">
                    <a href="{{url('backside/super_admin/shop_owner_using_chat')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-comment"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Chat list.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Chat list.svg'}}" alt=""/>
                ...
                <li class="nav-item">
                    <a href= "" class="mobile-nav nav-link">
                        ...
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Activity Logs.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Activity Logs.svg'}}" alt=""/>
                        <p>
                            Activity Logs
                            <i class="right fas fa-angle-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('activity.customer')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">User Activities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <!--<li class="nav-item">-->
                        <!--    <a href="{{url('backside/super_admin/daily_shop_create_log')}}" class="nav-link border-0">-->
                        <!--        {{--                                <i class="far fa-circle nav-icon"></i>--}}-->
                        <!--        <i class="fa fa-circle pl-5"></i>-->
                ...
                <li class="nav-item">
                    <a href="{{url('/backside/super_admin/directory/all')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-store"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Shops directory.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Shops directory.svg'}}" alt=""/>
                        <p>
                            Shops Directory
                            <i class="right fas fa-angle-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('/backside/super_admin/directory/all')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">All Shops Directory</p>

                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('/backside/super_admin/directory/create')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">Add Shop Directory</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{url('/backside/super_admin/support/list')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-info-circle"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Baydin.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Baydin.svg'}}" alt=""/>
                        <p>
                        Baydin
                            <i class="right fas fa-angle-right"></i>
                ...
                <li class="nav-item">
                    <a href="{{url('/backside/super_admin/support/list')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-info-circle"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Help _ Support.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile d-none rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Help _ Support.svg'}}" alt=""/>
                        <p>
                        Help And Support
                            <i class="right fas fa-angle-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('/backside/super_admin/support/list')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{url('/backside/super_admin/support/cat/list')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                ...
                <li class="nav-item">
                    {{-- <a href="{{url('backside/super_admin')}}" class="nav-link"> --}}
                    {{-- <a href="{{url('backside/super_admin/sitesetting')}}" class="nav-link"> --}}
                    <a href="{{url('/backside/super_admin/tooltips/list')}}" class="mobile-nav nav-link">
                        <!-- <i class="nav-icon fas fa-toolbox"></i> -->
                        <img id="logo" class="logo rounded-5" src="{{'/images/logo/super_admin_logo/Tooltips.svg'}}" alt=""/>
                        <img id="mobile" class="logo mobile rounded-5" src="{{'/images/logo/super_admin_mobile_logo/Tooltips.svg'}}" alt=""/>
                        <p>Tooltips</p>
                    </a>
                </li>
            </ul>
            ...
            <ul class="nav nav-pills nav-sidebar mt-3 flex-column nav-flat">
                <li class="nav-item">
                    ...
                    <form id="logout-form" action="{{route('backside.super_admin.logout')}}" method="POST"
                          style="display: none;">
