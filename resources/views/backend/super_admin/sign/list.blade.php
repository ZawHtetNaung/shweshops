                                    ...
                                    <table id="newsTable" class="table table-bordered table-striped">
                                        ...
                                        @foreach($signs as $sign)
                                            <tr>
                                              ...
                                              <td class="w-25"><img class="rounded-5 shadow-sm" src="{{'/images/baydin/'. $sign->photo}}" alt="" width="150px" height="60px"/></td>
                                              <td class="w-25"><img class="center rounded-5 shadow-sm" src="{{'/images/baydin/sign/'. $sign->sign_logo}}" alt="" width="70px" height="60px"/></td>
                                                    ...
                                                    <div class="title">
                                                        <div class="edit-section p-2 ">
                                                            <div class="d-block d-lg-flex align-items-center justify-content-around">
                                                                <a href="{{ route('baydins.edit',$sign->id)}}" class="btn btn-sm btn-info"><i class="far fa-edit"></i></a> | 
                                                               
                                                                    <button type = "button" onclick="delete_sign('{{$sign->id}}')" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button>
                
                                                                | <a href="{{ route('baydins.show',$sign->id)}}" class="btn btn-sm btn-warning"><i class="far fa-eye"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
