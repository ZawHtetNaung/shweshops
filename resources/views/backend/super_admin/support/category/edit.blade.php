                                ...
                                <div class="card shadow-none card-outline card-primary rounded-5 pb-2 mt-5">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2><i class="nav-icon fas fa-toolbox"></i> Edit Category for support </h2>
                                    ...
                                    <div class="card-body p-lg-5">
                                        <form method="POST"
                                              action="{{ url('backside/super_admin/support/cat/edit/' . $tooltip->id) }}">
                                            @csrf
                                            ...
                                            <a href="{{ url('backside/super_admin/support/cat/list')}}"
