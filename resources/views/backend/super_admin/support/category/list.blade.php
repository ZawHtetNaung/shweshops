                                            ...
                                            @foreach($cats as $c)
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex justify-content-around w-75">
                                                        ...
                                                        <a href="{{url('backside/super_admin/support/cat/edit/'.$c->id)}}" role="button" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Shop Edit">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <form action="{{url('backside/super_admin/support/cat/delete')}}" method="post">
                                                            <input type="hidden" name="_token" value="OaWW8df5rfIPNgapLNABDlC36emev9vvKcSOKpzy">
                                                            <input type="hidden" name="id" value="{{$c->id}}">
                                                            <button type="button" onclick="Delete(this)" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Move To Trash">
