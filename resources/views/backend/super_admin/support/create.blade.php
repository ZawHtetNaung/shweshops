                                ...
                                <div class="card shadow-none card-outline card-primary rounded-5 pb-2 mt-5">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2><i class="nav-icon fas fa-toolbox"></i> Create Support Video </h2>
                                            <a href="{{ url('/backside/super_admin/tooltips/list') }}"> <i
                                                    class="fas fa-list"></i></a>
                                        </div>
                                    </div>
                                    <div class="card-body p-lg-5">
                                        <form method="POST" action="{{ url('backside/super_admin/support/create') }}">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control sop-form-control" rows="4" name="video"
                                                          required>
                                                    {{old('video')}}
                                                </textarea>
                                                @error('video')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="state" name="for_what"
                                                        class="form-control @error('for_what') is-invalid @enderror"
                                                        required>
                                                    @if (old('for_what') == 'for_so')
                                            ...
                                            <div class="form-group">
                                                <label for="state">Category<span style="color: red;">*</span></label>
