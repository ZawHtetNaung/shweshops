                                    ...
                                    <div class="card-body p-lg-5">
                                        <form method="POST"  action="{{ url('backside/super_admin/tooltips/create') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('endpoint') }}" name="endpoint" class="form-control @error('endpoint') is-invalid @enderror" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter name" required>
                                                @error('endpoint')
