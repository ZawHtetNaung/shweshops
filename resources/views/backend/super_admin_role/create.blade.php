                                 ...
                                 <form method="POST"  action="{{ route('super_admin_role.create') }}">
                                    @csrf
                                        <div class="form-group">
                                            ...
                                            <input type="name" value="{{ old('name') }}" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter name">
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" value="{{ old('email') }}" name="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password" value="{{ old('password') }}" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation"  autocomplete="new-password">
                                            @error('password')
                                            <small class="font-weight-bold text-danger">*{{ $message }}</small> 
                                            @enderror
                                        </div>
