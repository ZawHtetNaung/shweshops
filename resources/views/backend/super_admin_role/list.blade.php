                              ...
                              <div class="card shadow-none card-outline card-primary rounded-5  mt-5">
                                  <div class="card-header">
                                    <div class=" d-flex justify-content-between align-items-center">
                                      ...
                                      <a href="{{route('super_admin_role.create')}}" role="button" class="btn btn-primary"> Create Admin </a>
                                    </div>
                                  </div>
                  ...
                  <div class="col-12">
                      ...
                      <div class="sn-table-list-wrapper">
                          ...
                          <div class="card shadow-none border-0 rounded-5 pb-2 mt-5">
                              ...
                              <table id="superAdminActivityTable" class="table table-borderless">
                                <thead>
                                  <tr>
                                    <th>id</th>
                                    <th>Name</th>
    ...
    columns: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          ...
          if(`{{Auth::guard('super_admin')->user()->id }}` && `{{Auth::guard('super_admin')->user()->id }}` == row.id){
              var edit = `
