            ...
            <div class="row pb-5 pb-md-0">
                <div class="col-lg-8 col-md-12">
                    <div class="sn-main-promo">
                        <img class="" src="{{ asset('images/news_&_events/event/' . $event->photo)}}" alt="">
                ...
                <div class="col-lg-4 col-md-12" id="newsPanel">
                    <div class="sn-latest-news">
                       ...
                       @forelse ($other_events as $e)
                        <div class="mb-5">
                            <a href="{{route('events.detail',$e->slug)}}"><img class="w-100" src="{{ asset('images/news_&_events/event/' . $e->photo)}}" alt=""></a>
                            <a href="{{route('events.detail',$e->slug)}}">
                       ...
                       @endforelse
                        ...
                        {{--                </div>--}}
                        <a href="/events" class="sn-latest-news-button float">Load More</a>
