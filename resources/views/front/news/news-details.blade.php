            ...
            <div class="row pb-5 pb-md-0">
                <div class="col-lg-8 col-md-12">
                    <div class="sn-main-promo">
                        <img class="" src="{{ asset('images/news_&_events/news/' . $news->image)}}" alt="">
                ...
                <div class="col-lg-4 col-md-12" id="newsPanel">
                    <div class="sn-latest-news">
                        <h2 class="sn-latest-news-title">More News</h2>
                         ...
                         <div class="mb-5">
                            <a href="{{ route('news.detail',$n->slug)}}" target="_blank" rel="noopener noreferrer">
                                <img class="w-100" src="{{ asset('images/news_&_events/news/' . $n->image)}}" alt="">
                            </a>
                            <a href="{{ route('news.detail',$n->slug)}}">
                            <h6 class="mt-3 text-black more-news-title">{{ $n->title }}</h6>
                            </a>
                            <p class="mb-3 mt-2"><span><i class="fa-solid fa-calendar-days"></i></span> {{ $n->created_at->format('d M Y')}}</p>
