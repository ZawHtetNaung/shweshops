                ...
                <div class="col-lg-8 col-md-12">
                  <div id="newsPanel" class="d-lg-block">
                    <div>
                      ...
                      @if ($latestNews)
                          <a href="{{ route('news.detail',$latestNews->slug)}}" class="sn-fs-promo">
                          ...
                          <div>
                              ...
                              <span><a class="text-blue text-decoration-underline" href="{{route('news.detail',$latestNews->slug)}}">... See More</a></span></p>
                          </div>
                      @else
