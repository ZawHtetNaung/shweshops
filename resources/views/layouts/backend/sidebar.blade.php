<aside class="main-sidebar sidebar-dark-primary elevation-4" style="z-index: 99999;">
    ...
    <div class="sidebar">
        ...
        <a href="{{url('backside/shop_owner/shop')}}" class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
            <div class="image">
                <img src="{{url('/images/logo/'.$current_shop->shop_logo)}}" class="img-circle elevation-2"
                     alt="User Image">
            </div>
    ...
    <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar  flex-column nav-flat sop-sidebar" data-widget="treeview" role="menu"
                ...
                <li class="nav-item py-1">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item py-1">
                            <a href="{{route('backside.shop_owner.items.template.list')}}" class="nav-link border-0">
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">List</p>
                            </a>
                        </li>
                        <li class="nav-item py-1">
                            <a href="{{route('backside.shop_owner.items.template.create')}}" class="nav-link border-0">
                                <i class="fa fa-circle pl-5"></i>
                ...
                @if(isset(Auth::guard('shop_owner')->user()->id) || (Auth::guard('shop_role')->user()->role_id == 2) || (Auth::guard('shop_role')->user()->role_id == 1))
                    <li class="nav-item py-1">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('backside.shop_owner.so_activity.u_product')}}" class="nav-link border-0">
                                <i class="fa fa-circle pl-5"></i>
                                <p class="ml-3">Product Activities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('backside.shop_owner.so_activity.u_role')}}" class="nav-link border-0">
                                <i class="fa fa-circle pl-5"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('backside.shop_owner.so_activity.p_product')}}" class="nav-link border-0">
                                <i class="fa fa-circle pl-5"></i>
                ...
                @can('can_use_pos')
                    <li class="nav-item py-1">
                        <a href="{{route('backside.shop_owner.pos.sale_page')}}" class="nav-link">
