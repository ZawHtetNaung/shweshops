                            ...
                            <div class="col-12">
                                <article class="post-wrapper align-items-center">
                                    <div class="text-center post-img">
                                        <a class=""
                                           href="{{url($shop_data->withoutspace_shopname.'/'.$acc->category_id.'/'.$shop_data->id)}}">
                                    ...
                                    <div class="post-info text-center">
                                        <header class="entry-header">
                                            <!-- Blog Title -->
                                            <h3 class="yk-product-title "><a class="zh-amount"
                                                                             href="{{url($shop_data->shop_name.'/'.$acc->category_id)}}">
                                                    {{$acc->mm_name}}</a>
