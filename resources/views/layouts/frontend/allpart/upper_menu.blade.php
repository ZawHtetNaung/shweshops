<div class="sop-upper-s d-none d-lg-block px-lg-5">
    <div class="sop-upper-nav-text text1">
        ...
        မြန်မာတစ်နိုင်ငံလုံးရှိ <span class="sop-upper-nav-text-y">စိန်ရွှေရတနာဆိုင်များကို</span> တစ်နေရာတည်းတွင် ဝင်ရောက်ကြည့်ရှုကာ ယုံကြည်စိတ်ချစွာဝယ်ယူနိုင်မယ့် <span class="sop-upper-nav-text-y">Shwe Shops<span>
    </div>
    ...
    <div class="h-100 d-flex justify-content-between align-items-center">
                ...
                <div class="pe-3 dropdown sop-drop d-none">
                    ...
                    <ul>
                        <li class="nav-item dropdown" style="list-style-type:none;margin-right: 0px;">
                            <a href="#language-change-w" class="nav-link" data-toggle="dropdown" style="font-weight: 600">
                                <i class="fas fa-globe pe-2" style="color: #F7B538!important;"></i> ဘာသာစကား<i class="fa-solid fa-angle-down ps-1"></i>
                            </a>
        ...
        <div class="d-flex justify-content-end align-items-center col-4">
               ...
               {{-- <div class="sop-upper-nav-text-l menu-profile rounded-circle ml-2">
                ...
                <div class="sop-upper-nav-text-l px-2">
                    <a href="" title="checkForm" data-toggle="modal" data-target="#orangeModalSubscription" class="checkForm">Login</a>
                </div>
                @endif
...
@push('css')
    ...
    <style>
        ...
        @keyframes slide-3 {
            ...
            74.96%, 91.62% { right: 4rem; opacity: 1; }
            100% { right: 110%; opacity: 0; }
        }
        @keyframes slide-2{
            0%, 33.33% { right: -100%; opacity: 0; }
            41.63%, 58.29% { right: 4rem; opacity: 1; }
            66.66%, 100% { right: 110%; opacity: 0; }
        }
        @keyframes slide {
            0%, 8.3% { right: -100%; opacity: 0; }
            8.3%,25% { right: 4rem; opacity: 1; }
