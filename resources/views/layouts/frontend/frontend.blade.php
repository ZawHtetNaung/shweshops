...
<head>
    ...
    * ---------------------------------------------- */
    ...
    <link rel='stylesheet' id='mmm_mega_main_menu-css'
          href="{{url('test/wp-content/plugins/mega_main_menu/src/css/cache.skin.css')}}" type='text/css' media='all'/>
...
<script type='text/javascript' src="{{url('test/wp-content/plugins/themeftc-for-elementor/assets/js/frontend.js')}}"
        id='ftcs-js-js'></script>


<script type='text/javascript' id='wc-cart-fragments-js-extra'>
    /* <![CDATA[ */
    var wc_cart_fragments_params = {
        "ajax_url": "\/wp-admin\/admin-ajax.phpfe",
        "wc_ajax_url": "\/?wc-ajax=%%endpoint%%",
        "cart_hash_key": "wc_cart_hash_55c4d712928b9aa04261d1bafa93a2f5",
        "fragment_name": "wc_fragments_55c4d712928b9aa04261d1bafa93a2f5",
...
<script type='text/javascript' id='yith-wcan-script-js-extra'>
    ...
    var yith_wcan = {
        ...
        "avada": {"is_enabled": false, "sort_count": "ul.sort-count.order-dropdown"},
        "flatsome": {"is_enabled": false, "lazy_load_enabled": false},
        "yootheme": {"is_enabled": false}
    };
    /* ]]> */
</script>
...
<script type='text/javascript' id='yith-woocompare-main-js-extra'>
    ...
    var yith_woocompare = {
        ...
        "auto_open": "yes",
        "loader": "",
        "button_text": "<i class=\"icon-refresh\"><\/i><span class=\"ftc-tooltip button-tooltip\">Compare<\/span>",
...
<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/infinite-scroll.pkgd.min.js')}}"
        id='infinite-scroll-js'></script>

<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/jquery.swipebox.js')}}"
        id='swipebox-js'></script>
<script type='text/javascript' src="{{url('test/js/owl.js')}}"
        id='owl-carousel-js'></script>
<script src='{{url('test/js/owl.thumbs.js')}}'></script>
<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/jquery.prettyphoto.js')}}"
        id='jquery.prettyphoto-js'></script>


<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/jquery.smartmenus.js')}}"
        id='smartmenus-js'></script>
<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/jquery.scrollto.js')}}"
...
{{--Important Js --}}
<script type='text/javascript' src="{{url('test/wp-content/themes/karo1/assets/js/custom.js')}}"
        id='ftc-global-js'></script>
{{--Important Js --}}
...
<script type='text/javascript'
        src="{{url('test/wp-content/plugins/woocommerce/assets/js/jquery-ui-touch-punch/jquery-ui-touch-punch.js')}}"
...
<script type='text/javascript' src="{{url('test/js/forproductdetail.js')}}"
></script>
<script src="{{url('test/js/select2.js')}}"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //     $(".shop_nav ").addClass('active');

        // });


        $("#zh-select_type").click(function () {
            $(".zh-type").addClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").removeClass('active');
            $(".zh-cat").removeClass('active');
            $(".zh-g_type").removeClass('active');
            $(".zh-g_color").removeClass('active');
        });

        $("#zh-select_sort").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").addClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").removeClass('active');
            $(".zh-cat").removeClass('active');
            $(".zh-g_type").removeClass('active');
        ...
        $("#zh-select_price").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").addClass('active');
            $(".zh-shops").removeClass('active');
            $(".zh-cat").removeClass('active');
            $(".zh-g_type").removeClass('active');
            $(".zh-g_color").removeClass('active');
        });
        $("#zh-select_shops").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").addClass('active');
            $(".zh-cat").removeClass('active');
            $(".zh-g_type").removeClass('active');
            $(".zh-g_color").removeClass('active');
        });
        $("#zh-select_cat").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").removeClass('active');
            $(".zh-cat").addClass('active');
            $(".zh-g_type").removeClass('active');
            $(".zh-g_color").removeClass('active');
        });
        $("#zh-select_g_type").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").removeClass('active');
            $(".zh-cat").removeClass('active');
            $(".zh-g_type").addClass('active');
            $(".zh-g_color").removeClass('active');
        });
        $("#zh-select_g_color").click(function () {
            $(".zh-type").removeClass('active');
            $(".zh-sort_by").removeClass('active');
            $(".zh-price").removeClass('active');
            $(".zh-shops").removeClass('active');
    ...
    jQuery(function ($) {
        ...
        $('#zh_Recommend_slide').owlCarousel({
            loop: false,
            margin: 10,
            responsiveClass: true,
            autoplay: false,
            ...
            loop: false,
            navText: [
                '<button class="zh-slide-btn_left"><i class="zh_slide_arr_right fa fa-angle-left" aria-hidden="true"></button></i>',
                '<button class="zh-slide-btn_right"><i class="zh_slide_arr_left fa fa-angle-right" aria-hidden="true"></button></i>'
            ],
            responsive: {
                0: {
                    items: 1,
        ...
        $('#similar_slide').owlCarousel({
            ...
            loop: false,
            navText: [
                '<button class="yk-slide-btn d-none"><i class="fa fa-angle-left" aria-hidden="true"></button></i>',
                '<button class="yk-slide-btn d-none"><i class="fa fa-angle-right" aria-hidden="true"></button></i>'
            ],
            responsive: {
                0: {
                    items: 2,
                ...
                $("#testkyattar").keyup(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            document.myform.kyattartotal.value = total.toFixed(0);
